...
describe('user', () => {
  ...
  it('must have a first name', ()=>{
    ...
    expect(() => makeUser(user)).toThrow('"fullName.firstName" is required');
  });
  ...
  it('first name not allowed to be empty', ()=>{
    ...
    expect(() => makeUser(user)).toThrow('"fullName.firstName" is not allowed to be empty');
  });
  ...
  it('first name must be of Type string', ()=>{
    ...
    expect(() => makeUser(user)).toThrow('"fullName.firstName" must be a string');
  });
  ...
  it('first name must only contain alpha-numeric characters', ()=>{
    ...
    expect(()=> makeUser(user)).toThrow('"fullName.firstName" must only contain alpha-numeric characters');
  });
  ...
  it('first name must be at least 3 characters long', ()=>{
    ...
    expect(()=> makeUser(user)).toThrow('"fullName.firstName" length must be at least 3 characters long');
  });
  ...
  it('first name must be less than or equal to 30 characters long', ()=>{
    ...
    expect(()=> makeUser(user)).toThrow('"fullName.firstName" length must be less than or equal to 30 characters long');
  });
  ...
  it('must have a last name', ()=>{
    ...
    expect(() =>makeUser(user)).toThrow('"fullName.lastName" is required');
  });
  ...
  it('last name not allowed to be empty', ()=>{
    ...
    expect(() =>makeUser(user)).toThrow('"fullName.lastName" is not allowed to be empty');
  });
  ...
  it('last name must only contain alpha-numeric characters', ()=>{
    ...
    expect(()=>makeUser(user)).toThrow('"fullName.lastName" must only contain alpha-numeric characters');
  });
  ...
  it('last name must be less than or equal to 30 characters long', ()=>{
    ...
    expect(()=> makeUser(user)).toThrow('"fullName.lastName" length must be less than or equal to 30 characters long');
  });
  ...
  it('email not allowed to be empty', ()=>{
    ...
    expect(()=> makeUser(user)).toThrow('"email" is not allowed to be empty');
  });
  ...
  it('must have a valid email', ()=>{
    ...
    expect(()=> makeUser(user)).toThrow('"email" must be a valid email');
  });
  ...
  it('must have a role', ()=>{
    ...
    expect(()=> makeUser(user)).toThrow('"role" must be one of [0, 1]');
  });
  ...
  it('password is not allowed to be empty', ()=>{
    ...
    expect(()=> makeUser(user)).toThrow('"password" is not allowed to be empty');
  });
  ...
  it('password must be at least 8 characters long', ()=>{
    ...
    expect(()=> makeUser(user)).toThrow('"password" length must be at least 8 characters long');
  });
  ...
  it('password must only contain alpha-numeric characters', ()=>{
    ...
    expect(()=> makeUser(user)).toThrow('"password" must only contain alpha-numeric characters');
  });
  ...
  it('password must be less than or equal to 30 characters long', ()=>{
    ...
    const user = makeFakeUser({password: password});
    expect(()=> makeUser(user)).toThrow('"password" length must be less than or equal to 30 characters long');
  });
  ...
  it('must have a repeat password', ()=>{
    ...
    expect(()=> makeUser(user)).toThrow('"repeatPassword" is required');
  });
  ...
  it('repeat password must be equal to password', ()=>{
    ...
    expect(()=> makeUser(user)).toThrow('"repeatPassword" must be [ref:password]');
  });
  ...
  it('createdOn is required', ()=>{
    ...
    expect(()=> makeUser(user)).toThrow('"createdOn" is required');
  });
  ...
  it('createdOn must be valid date', ()=>{
    ...
    expect(()=> makeUser(user)).toThrow('"createdOn" must be a valid date');
  });
  ...
  it('createdOn must be of Type ISO 8601 date format', ()=>{
    ...
    expect(()=> makeUser(user)).toThrow('"createdOn" must be in ISO 8601 date format');
  });


  it('createdOn must be greater than or equal to 2019-12-31T23:00:00 ', ()=>{
    const createdOn = new Date(2019, 11, 31, 23, 59, 59, 0);
    const user = makeFakeUser({createdOn: createdOn});

    expect(()=> makeUser(user)).toThrow('"createdOn" must be larger than or equal to "2019-12-31T23:00:00.000Z"');
  });
  ...
  it('modifiedOn is required', ()=>{
    ...
    expect(()=> makeUser(user)).toThrow('"modifiedOn" is required');
  });
  ...
  it('modifiedOn must be valid date', ()=>{
    ...
    expect(()=> makeUser(user)).toThrow('"modifiedOn" must be a valid date');
  });
  ...
  it('modifiedOn must be of Type ISO 8601 date format', ()=>{
    ...
    expect(()=> makeUser(user)).toThrow('"modifiedOn" must be in ISO 8601 date format');
  });
  ...
  it('modifiedOn must be larger than or equal to 2019-12-31T23:00:00 ', ()=>{
    ...
    expect(()=> makeUser(user)).toThrow('"modifiedOn" must be larger than or equal to "2019-12-31T23:00:00.000Z"');
  });
